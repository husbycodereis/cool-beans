...
class History: ObservableObject {
    //@Published notifies the whole project when the value of the variable changes
    ...
    func save(){
        do {
            ...
            //atomic moves the whole file into a temporary location, and renames it to the correct file
            //completefileprotection is a security measure that only runs if the user unlocks their device
